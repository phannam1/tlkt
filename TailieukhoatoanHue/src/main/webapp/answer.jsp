							...
							<ul>
								<li>
									<article class="aa-properties-item1">
										<a class="aa-properties-item-img2"> 
										</a>
				...
				<div class="col-md-12">
					<aside class="aa-properties-sidebar">
						...
						<div class="aa-properties-single-sidebar">
							<h3 style="text-align: center;">Các Câu trả lời </h3>
...
<div class="col-md-12">
												<aside class="aa-properties-sidebar">
													<!-- Start Single properties sidebar -->
													<i class="fa fa-reply" aria-hidden="true"></i><label>Câu trả lời của bạn:</label>
													<div class="aa-properties-single-sidebar">
